      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">
          ...
          <span className="pl-4 font-normal text-gray-800">
            ...
            assumenda culpa distinctio atque veritatis voluptate placeat alias
            dignissimos fuga tempore.
          </span>
        </h1>
        <h1 className="font-bold my-1">
          Experience:{" "}
        ...
        <h1 className="font-bold my-1">
          Posted Data:{" "}
          <span className="pl-4 font-normal text-gray-800">11-08-2024</span>
        </h1>
      </div>
    </div>
  );
