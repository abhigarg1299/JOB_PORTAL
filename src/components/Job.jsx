    ...
    <div className="p-5 rounded-md  shadow-xl bg-white border-gray-100">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600">
          ...
          fuga tempore accusamus animi ut eaque, a sequi magni deserunt, facere
          mollitia asperiores molestiae sit sapiente rem in iure repellendus.
        </p>
      </div>
